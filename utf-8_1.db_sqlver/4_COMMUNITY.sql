...
INSERT INTO community (idx,writer,title,content)
VALUES (community_idx_seq.nextval, 'maru080818','기네스 세계 기록 2024','2023년 광화문 광장에서 약10,000명이 태권도 태극 1장을 하여 기네스북에 올랐다는 사실, 알고 계셨나요?
...
INSERT INTO community (idx,writer,title,content)
VALUES (community_idx_seq.nextval, 'nara34','시간을 달리는 소년','넘 기대되는 책이예요 도착하자마자 사진부터 찰칵!
이제 뜯어서 밤새도록 읽을꺼예요.
회사에서 일상을 투정하며 보낸 저를 반성하며');
INSERT INTO community (idx,writer,title,content)
VALUES (community_idx_seq.nextval, 'wonder','라이칸','좋아하는 작가님 책이라 아묻따 구매했어요
기대됩니다 ');
INSERT INTO community (idx,writer,title,content)
VALUES (community_idx_seq.nextval, 'maru080818','달의 아이','결론이 예측되지 않아서 더 집중해서 봤어요.
하나의 재난을 극복하기 위한 이겨내기 위한 서로 다른 선택..
그들의 선택에 생각을 많이 하게 되네요');
INSERT INTO community (idx,writer,title,content)
VALUES (community_idx_seq.nextval, 'kevin','결혼 피로연','잘읽었습니다잘읽었습니다');